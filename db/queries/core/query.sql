...
update merch set redeemed = true where token_id = @token_hex returning discount_code;

-- name: RedeemMerchMany :many
update merch set redeemed = true where token_id = any(@tokens_hex) returning discount_code;
