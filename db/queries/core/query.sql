...
update merch set redeemed = true where token_id = @token_hex returning token_id,discount_code;

-- name: RedeemMerchMany :many
update merch set redeemed = true where token_id = any(@tokens_hex) returning token_id,discount_code;
