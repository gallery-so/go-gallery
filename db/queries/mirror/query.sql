...
-- name: ProcessBaseSepoliaOwnerEntry :batchexec
with deletion as (
    delete from base_sepolia.owners where @should_delete::bool and simplehash_kafka_key = @simplehash_kafka_key
)
...
-- name: ProcessBaseSepoliaTokenEntry :batchone
with deletion as (
    delete from base_sepolia.tokens where @should_delete::bool and base_sepolia.tokens.simplehash_kafka_key = @simplehash_kafka_key
),
...
-- name: UpdateBaseSepoliaContract :batchexec
