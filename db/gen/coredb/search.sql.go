...
select contracts.id, contracts.deleted, contracts.version, contracts.created_at, contracts.last_updated, contracts.name, contracts.symbol, contracts.address, contracts.creator_address, contracts.chain, contracts.profile_banner_url, contracts.profile_image_url, contracts.badge_url, contracts.description, contracts.parent_id, contracts.owner_address, contracts.is_provider_marked_spam from contracts left join contract_relevance on contract_relevance.id = contracts.id,
