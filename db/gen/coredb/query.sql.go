...
select exists(select 1 from tokens where owner_user_id = $1 and token_id = $2 and contract_id = $3 and chain = $4 and displayable and deleted = false) as owns_token
`
