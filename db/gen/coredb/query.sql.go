...
with user_tokens as (select count(*) total from tokens where id = any($2::dbid[]) and owner_user_id = $1 and not tokens.deleted), total_tokens as (select cardinality($2) total)
...
select count(*)
from posts
where $1::dbid = any(posts.contract_ids)
...
INSERT INTO events (id, actor_id, action, resource_type_id, admire_id, feed_event_id, post_id, token_id, comment_id, subject_id, data, group_id, caption) VALUES ($1, $2, $3, $4, $5, $10::text, $11::text, $12::text, $13::text, $6, $7, $8, $9) RETURNING id, version, actor_id, resource_type_id, subject_id, user_id, token_id, collection_id, action, data, deleted, last_updated, created_at, gallery_id, comment_id, admire_id, feed_event_id, external_id, caption, group_id, post_id, mention_id, community_id
`
...
INSERT INTO notifications (id, owner_id, action, data, event_ids, feed_event_id, post_id, token_id) VALUES ($1, $2, $3, $4, $5, $6::text, $7::text, $8::text) RETURNING id, deleted, owner_id, version, last_updated, created_at, action, data, event_ids, feed_event_id, comment_id, gallery_id, seen, amount, post_id, token_id, mention_id, community_id
`
...
INSERT INTO events (id, actor_id, action, resource_type_id, comment_id, feed_event_id, post_id, mention_id, subject_id, data, group_id, caption) VALUES ($1, $2, $3, $4, $5, $10::text, $11::text, $12::text, $6, $7, $8, $9) RETURNING id, version, actor_id, resource_type_id, subject_id, user_id, token_id, collection_id, action, data, deleted, last_updated, created_at, gallery_id, comment_id, admire_id, feed_event_id, external_id, caption, group_id, post_id, mention_id, community_id
`
...
INSERT INTO notifications (id, owner_id, action, data, event_ids, feed_event_id, post_id, comment_id) VALUES ($1, $2, $3, $4, $5, $7::text, $8::text, $6) RETURNING id, deleted, owner_id, version, last_updated, created_at, action, data, event_ids, feed_event_id, comment_id, gallery_id, seen, amount, post_id, token_id, mention_id, community_id
`
...
INSERT INTO events (id, actor_id, action, resource_type_id, community_id, subject_id, post_id, comment_id, feed_event_id, mention_id, data, group_id, caption) VALUES ($1, $2, $3, $4, $5, $5, $9::text, $10::text, $11::text, $12::text, $6, $7, $8) RETURNING id, version, actor_id, resource_type_id, subject_id, user_id, token_id, collection_id, action, data, deleted, last_updated, created_at, gallery_id, comment_id, admire_id, feed_event_id, external_id, caption, group_id, post_id, mention_id, community_id
`
...
INSERT INTO notifications (id, owner_id, action, data, event_ids, feed_event_id, post_id, comment_id, community_id, mention_id) VALUES ($1, $2, $3, $4, $5, $8::text, $9::text, $10::text, $6, $7) RETURNING id, deleted, owner_id, version, last_updated, created_at, action, data, event_ids, feed_event_id, comment_id, gallery_id, seen, amount, post_id, token_id, mention_id, community_id
`
...
INSERT INTO notifications (id, owner_id, action, data, event_ids, feed_event_id, post_id, comment_id, mention_id) VALUES ($1, $2, $3, $4, $5, $7::text, $8::text, $9::text, $6) RETURNING id, deleted, owner_id, version, last_updated, created_at, action, data, event_ids, feed_event_id, comment_id, gallery_id, seen, amount, post_id, token_id, mention_id, community_id
`
...
INSERT INTO events (id, actor_id, action, resource_type_id, token_id, subject_id, data, group_id, caption, gallery_id, collection_id) VALUES ($1, $2, $3, $4, $5, $5, $6, $7, $8, $9::text, $10::text) RETURNING id, version, actor_id, resource_type_id, subject_id, user_id, token_id, collection_id, action, data, deleted, last_updated, created_at, gallery_id, comment_id, admire_id, feed_event_id, external_id, caption, group_id, post_id, mention_id, community_id
`
...
INSERT INTO events (id, actor_id, action, resource_type_id, user_id, subject_id, post_id, comment_id, feed_event_id, mention_id, data, group_id, caption) VALUES ($1, $2, $3, $4, $5, $5, $9::text, $10::text, $11::text, $12::text, $6, $7, $8) RETURNING id, version, actor_id, resource_type_id, subject_id, user_id, token_id, collection_id, action, data, deleted, last_updated, created_at, gallery_id, comment_id, admire_id, feed_event_id, external_id, caption, group_id, post_id, mention_id, community_id
`
...
INSERT INTO notifications (id, owner_id, action, data, event_ids, post_id, community_id) VALUES ($1, $2, $3, $4, $5, $7::text, $6) RETURNING id, deleted, owner_id, version, last_updated, created_at, action, data, event_ids, feed_event_id, comment_id, gallery_id, seen, amount, post_id, token_id, mention_id, community_id
`
...
update push_notification_tokens set deleted = true where id = any($1::dbid[]) and deleted = false
`
...
update user_roles set deleted = true, last_updated = now() where user_id = $1 and role = any($2::role[])
`
...
SELECT id, version, feed_event_id, actor_id, deleted, created_at, last_updated, post_id, token_id, comment_id from admires WHERE id = ANY($1::dbid[]) AND deleted = false
`
...
SELECT id, version, feed_event_id, actor_id, reply_to, comment, deleted, created_at, last_updated, post_id, removed, top_level_comment_id from comments WHERE id = ANY($1::dbid[]) AND deleted = false
`
...
select contracts.id, contracts.deleted, contracts.version, contracts.created_at, contracts.last_updated, contracts.name, contracts.symbol, contracts.address, contracts.creator_address, contracts.chain, contracts.profile_banner_url, contracts.profile_image_url, contracts.badge_url, contracts.description, contracts.owner_address, contracts.is_provider_marked_spam, contracts.parent_id, contracts.override_creator_user_id, contracts.l1_chain from contracts join tokens on contracts.id = tokens.contract_id where tokens.id = any($1::dbid[]) and contracts.deleted = false
`
...
select id, version, owner_id, action, data, event_time, event_ids, deleted, last_updated, created_at, caption, group_id from feed_events where deleted = false
    and owner_id = $1
    and action = any($3::action[])
    and data ->> 'collection_id' = $4::dbid
    and event_time < $2
...
where case when $8::bool then f.id is null else true end
    and (f.id is not null,user_view.created_at,user_view.id) < ($9::bool, $10::timestamptz, $11::dbid)
    and (f.id is not null,user_view.created_at,user_view.id) > ($12::bool, $13::timestamptz, $14::dbid)
...
from token_definitions
where (chain, contract_address, token_id) = ($1, $2::address, $3::hextokenid) and not deleted
`
...
where tokens.owner_user_id = $1 
    and (token_definitions.chain, token_definitions.contract_address, token_definitions.token_id) = ($2, $3::address, $4::hextokenid)
    and tokens.displayable
    and not tokens.deleted
    and not token_definitions.deleted
...
select t.id, t.deleted, t.version, t.created_at, t.last_updated, t.collectors_note, t.quantity, t.block_number, t.owner_user_id, t.owned_by_wallets, t.contract_id, t.is_user_marked_spam, t.last_synced, t.is_creator_token, t.token_definition_id, t.is_holder_token, t.displayable, td.id, td.created_at, td.last_updated, td.deleted, td.name, td.description, td.token_type, td.token_id, td.external_url, td.chain, td.metadata, td.fallback_media, td.contract_address, td.contract_id, td.token_media_id, td.is_fxhash, c.id, c.deleted, c.version, c.created_at, c.last_updated, c.name, c.symbol, c.address, c.creator_address, c.chain, c.profile_banner_url, c.profile_image_url, c.badge_url, c.description, c.owner_address, c.is_provider_marked_spam, c.parent_id, c.override_creator_user_id, c.l1_chain, u.id, u.deleted, u.version, u.last_updated, u.created_at, u.username, u.username_idempotent, u.wallets, u.bio, u.traits, u.universal, u.notification_settings, u.email_unsubscriptions, u.featured_gallery, u.primary_wallet_id, u.user_experiences, u.profile_image_id, u.persona from tokens t
    ...
    and (u.universal,t.created_at,t.id) < ($4, $5::timestamptz, $6::dbid)
    and (u.universal,t.created_at,t.id) > ($7, $8::timestamptz, $9::dbid)
...
SELECT id, deleted, version, last_updated, created_at, username, username_idempotent, wallets, bio, traits, universal, notification_settings, email_unsubscriptions, featured_gallery, primary_wallet_id, user_experiences, profile_image_id, persona FROM users WHERE (traits->$1::text) IS NOT NULL AND deleted = false
`
...
insert into mentions (id, user_id, community_id, comment_id, start, length) values ($1, $2::text, $3::text, $4, $5, $6) returning id, post_id, comment_id, user_id, start, length, created_at, deleted, community_id
`
...
insert into mentions (id, comment_id, user_id, community_id, start, length) values ($1, $2, $5::text, $6::text, $3, $4) returning id
`
...
insert into mentions (id, user_id, community_id, post_id, start, length) values ($1, $2::text, $3::text, $4, $5, $6) returning id, post_id, comment_id, user_id, start, length, created_at, deleted, community_id
`
...
, set_conditionally_current_media_to_inactive(last_updated) as (
    ...
    (
        ...
        from token_medias
        where id = (select token_media_id from token_definitions td where (td.chain, td.contract_address, td.token_id) = ($7, $8::address, $9::hextokenid) and not deleted)
        and not deleted
        and $10::bool
    )
...
where (fe.created_at, fe.id) < ($1, $2::dbid)
        and (fe.created_at, fe.id) > ($3, $4::dbid)
...
select fe.id, fe.feed_entity_type, fe.created_at, fe.actor_id from feed_entities fe, follows fl
    where fl.deleted = false
      ...
      and fl.follower = $1
      and (fe.created_at, fe.id) < ($2, $3::dbid)
      and (fe.created_at, fe.id) > ($4, $5::dbid)
order by
    case when $6::bool then (fe.created_at, fe.id) end asc,
    case when not $6::bool then (fe.created_at, fe.id) end desc
limit $7
...
WHERE (posts.created_at, posts.id) < ($1, $2::dbid)
  AND (posts.created_at, posts.id) > ($3, $4::dbid)
ORDER BY
...
from posts
where actor_id = $1
        and (created_at, id) < ($2, $3::dbid)
        and (created_at, id) > ($4, $5::dbid)
...
insert into reported_posts (id, post_id, reporter_id, reason) (select $1, offending_post.id, $2::text, $3 from offending_post)
...
func (q *Queries) UpdateHighlightMintClaimStatus(ctx context.Context, arg UpdateHighlightMintClaimStatusParams) (HighlightMintClaim, error) {
	row := q.db.QueryRow(ctx, updateHighlightMintClaimStatus, arg.Status, arg.ErrorMessage, arg.ID)
	var i HighlightMintClaim
	err := row.Scan(
		&i.ID,
		&i.RecipientUserID,
...
update tokens set is_user_marked_spam = $1, last_updated = now() where owner_user_id = $2 and id = any($3::dbid[]) and deleted = false
`
...
update users set featured_gallery = $1::dbid, last_updated = now() from galleries where users.id = $2 and galleries.id = $1 and galleries.owner_user_id = $2 and galleries.deleted = false
`
