...
const getOwnedTokenByIdentifiers = `-- name: GetOwnedTokenByIdentifiers :one
with user_owns as (
...
func (q *Queries) GetOwnedTokenByIdentifiers(ctx context.Context, arg GetOwnedTokenByIdentifiersParams) (Token, error) {
	row := q.db.QueryRow(ctx, getOwnedTokenByIdentifiers,
		arg.UserID,
		arg.Chain,
		arg.ContractAddress,
		arg.TokenID,
