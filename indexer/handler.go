...
func handlersInit(router *gin.Engine, i *Indexer, tokenRepository persist.TokenRepository, contractRepository persist.ContractRepository, userRepository persist.UserRepository, tq *task.Queue, ethClient *ethclient.Client, ipfsClient *shell.Shell, storageClient *storage.Client) *gin.Engine {
