...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "FeedEvent":
			resolverName, err := entityResolverNameForFeedEvent(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "FeedEvent": %w`, err)
			}
			switch resolverName {
			...
			case "findFeedEventByDbid":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findFeedEventByDbid(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindFeedEventByDbid(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "FeedEvent": %w`, err)
				}
...
func entityResolverNameForFeedEvent(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
