...
// User is the resolver for the user field.
func (r *someoneYouFollowOnFarcasterJoinedNotificationResolver) User(ctx context.Context, obj *model.SomeoneYouFollowOnFarcasterJoinedNotification) (*model.GalleryUser, error) {
	return resolveGalleryUserByUserID(ctx, obj.HelperSomeoneYouFollowOnFarcasterJoinedNotificationData.UserID)
}
...
// SomeoneYouFollowOnFarcasterJoinedNotification returns generated.SomeoneYouFollowOnFarcasterJoinedNotificationResolver implementation.
func (r *Resolver) SomeoneYouFollowOnFarcasterJoinedNotification() generated.SomeoneYouFollowOnFarcasterJoinedNotificationResolver {
