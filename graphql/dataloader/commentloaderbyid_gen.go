...
func (l *CommentLoaderByID) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *CommentLoaderByID) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewCommentLoaderByID(
	...
	loader.fetch = func(keys []persist.DBID) ([]coredb.Comment, []error) {
		ctx := loader.ctx

		// Allow the preFetchHook to modify and return a new context
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "CommentLoaderByID")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "CommentLoaderByID")
		}
