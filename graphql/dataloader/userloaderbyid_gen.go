...
func (l *UserLoaderByID) Load(key persist.DBID) (sqlc.User, error) {
...
func (l *UserLoaderByID) LoadThunk(key persist.DBID) func() (sqlc.User, error) {
	l.mu.Lock()
...
func (l *UserLoaderByID) LoadAll(keys []persist.DBID) ([]sqlc.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoaderByID) LoadAllThunk(keys []persist.DBID) func() ([]sqlc.User, []error) {
	results := make([]func() (sqlc.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoaderByID) Prime(key persist.DBID, value sqlc.User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoaderByID) unsafeSet(key persist.DBID, value sqlc.User) {
	if l.cache == nil {
