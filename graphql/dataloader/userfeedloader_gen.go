...
func NewUserFeedLoader(
	settings UserFeedLoaderSettings, fetch func(ctx context.Context, keys []coredb.PaginateUserFeedByUserIDParams) ([][]any, []error),
	opts ...func(interface {
	...
	loader.fetch = func(keys []coredb.PaginateUserFeedByUserIDParams) ([][]any, []error) {
		ctx := loader.ctx
...
type UserFeedLoader struct {
	...
	fetch func(keys []coredb.PaginateUserFeedByUserIDParams) ([][]any, []error)
	...
	cache map[coredb.PaginateUserFeedByUserIDParams][]any
...
func (l *UserFeedLoader) Load(key coredb.PaginateUserFeedByUserIDParams) ([]any, error) {
...
func (l *UserFeedLoader) LoadThunk(key coredb.PaginateUserFeedByUserIDParams) func() ([]any, error) {
	l.mu.Lock()
	if !l.disableCaching {
...
func (l *UserFeedLoader) LoadAll(keys []coredb.PaginateUserFeedByUserIDParams) ([][]any, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserFeedLoader) LoadAllThunk(keys []coredb.PaginateUserFeedByUserIDParams) func() ([][]any, []error) {
	results := make([]func() ([]any, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserFeedLoader) Prime(key coredb.PaginateUserFeedByUserIDParams, value []any) bool {
	if l.disableCaching {
		return false
	}
	l.mu.Lock()
...
func (l *UserFeedLoader) unsafeSet(key coredb.PaginateUserFeedByUserIDParams, value []any) {
	if l.cache == nil {
		l.cache = map[coredb.PaginateUserFeedByUserIDParams][]any{}
	}
	l.cache[key] = value
}
...
func (l *UserFeedLoader) publishToSubscribers(value []any) {
...
func (l *UserFeedLoader) ownsCacheFunc(f *func(any)) bool {
