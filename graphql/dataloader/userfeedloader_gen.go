...
func NewUserFeedLoader(
	settings UserFeedLoaderSettings, fetch func(ctx context.Context, keys []coredb.PaginateUserFeedByUserIDParams) ([][]persist.FeedEntity, []error),
	opts ...func(interface {
	...
	loader.fetch = func(keys []coredb.PaginateUserFeedByUserIDParams) ([][]persist.FeedEntity, []error) {
		ctx := loader.ctx
...
type UserFeedLoader struct {
	...
	fetch func(keys []coredb.PaginateUserFeedByUserIDParams) ([][]persist.FeedEntity, []error)
	...
	cache map[coredb.PaginateUserFeedByUserIDParams][]persist.FeedEntity
...
func (l *UserFeedLoader) Load(key coredb.PaginateUserFeedByUserIDParams) ([]persist.FeedEntity, error) {
...
func (l *UserFeedLoader) LoadThunk(key coredb.PaginateUserFeedByUserIDParams) func() ([]persist.FeedEntity, error) {
	l.mu.Lock()
	if !l.disableCaching {
...
func (l *UserFeedLoader) LoadAll(keys []coredb.PaginateUserFeedByUserIDParams) ([][]persist.FeedEntity, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserFeedLoader) LoadAllThunk(keys []coredb.PaginateUserFeedByUserIDParams) func() ([][]persist.FeedEntity, []error) {
	results := make([]func() ([]persist.FeedEntity, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserFeedLoader) Prime(key coredb.PaginateUserFeedByUserIDParams, value []persist.FeedEntity) bool {
	if l.disableCaching {
		return false
	}
	l.mu.Lock()
...
func (l *UserFeedLoader) unsafeSet(key coredb.PaginateUserFeedByUserIDParams, value []persist.FeedEntity) {
	if l.cache == nil {
		l.cache = map[coredb.PaginateUserFeedByUserIDParams][]persist.FeedEntity{}
	}
	l.cache[key] = value
}
...
func (l *UserFeedLoader) publishToSubscribers(value []persist.FeedEntity) {
...
func (l *UserFeedLoader) ownsCacheFunc(f *func(persist.FeedEntity)) bool {
