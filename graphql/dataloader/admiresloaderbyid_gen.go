...
func (l *AdmiresLoaderByID) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *AdmiresLoaderByID) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewAdmiresLoaderByID(
	...
	loader.fetch = func(keys []persist.DBID) ([][]coredb.Admire, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "AdmiresLoaderByID")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "AdmiresLoaderByID")
		}
