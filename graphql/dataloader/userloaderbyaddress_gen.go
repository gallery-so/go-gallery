...
=======
func (l *UserLoaderByAddress) Load(key persist.DBID) (coregen.User, error) {
>>>>>>> 93a3a41 (Add indexer models)
=======
func (l *UserLoaderByAddress) Load(key persist.DBID) (coregen.User, error) {
>>>>>>> a4e9c3f (Add indexer models)
...
=======
func (l *UserLoaderByAddress) LoadThunk(key persist.DBID) func() (coregen.User, error) {
	l.mu.Lock()
	if it, ok := l.cache[key]; ok {
		l.mu.Unlock()
...
=======
func (l *UserLoaderByAddress) LoadAll(keys []persist.DBID) ([]coregen.User, []error) {
...
func (l *UserLoaderByAddress) LoadAllThunk(keys []persist.DBID) func() ([]coredb.User, []error) {
	...
	return func() ([]coredb.User, []error) {
		users := make([]coredb.User, len(keys))
=======
func (l *UserLoaderByAddress) LoadAllThunk(keys []persist.DBID) func() ([]coregen.User, []error) {
	results := make([]func() (coregen.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
=======
func (l *UserLoaderByAddress) Prime(key persist.DBID, value coregen.User) bool {
>>>>>>> 93a3a41 (Add indexer models)
=======
func (l *UserLoaderByAddress) Prime(key persist.DBID, value coregen.User) bool {
>>>>>>> a4e9c3f (Add indexer models)
...
=======
func (l *UserLoaderByAddress) unsafeSet(key persist.DBID, value coregen.User) {
	if l.cache == nil {
