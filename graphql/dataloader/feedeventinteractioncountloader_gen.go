...
func (l *FeedEventInteractionCountLoader) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *FeedEventInteractionCountLoader) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewFeedEventInteractionCountLoader(
	...
	loader.fetch = func(keys []coredb.CountInteractionsByFeedEventIDBatchParams) ([][]coredb.CountInteractionsByFeedEventIDBatchRow, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "FeedEventInteractionCountLoader")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "FeedEventInteractionCountLoader")
		}
