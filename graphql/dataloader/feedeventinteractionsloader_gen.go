...
func (l *FeedEventInteractionsLoader) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *FeedEventInteractionsLoader) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewFeedEventInteractionsLoader(
	...
	loader.fetch = func(keys []coredb.PaginateInteractionsByFeedEventIDBatchParams) ([][]coredb.PaginateInteractionsByFeedEventIDBatchRow, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "FeedEventInteractionsLoader")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "FeedEventInteractionsLoader")
		}
