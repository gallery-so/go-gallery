...
func (l *GalleryLoaderByID) setPreFetchHook(preFetchHook func(context.Context, string) context.Context) {
	l.preFetchHook = preFetchHook
}

func (l *GalleryLoaderByID) setPostFetchHook(postFetchHook func(context.Context, string)) {
...
func NewGalleryLoaderByID(
	...
	loader.fetch = func(keys []persist.DBID) ([]coredb.Gallery, []error) {
		...
		if loader.preFetchHook != nil {
			ctx = loader.preFetchHook(ctx, "GalleryLoaderByID")
		}

		results, errors := fetch(ctx, keys)

		if loader.postFetchHook != nil {
			loader.postFetchHook(ctx, "GalleryLoaderByID")
		}
