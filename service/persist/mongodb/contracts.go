...
// ContractRepository is a repository for storing authentication nonces in a MongoDB database
type ContractRepository struct {
	contractsStorage *storage
}

// NewContractRepository returns a new instance of a login attempt repository
func NewContractRepository(mgoClient *mongo.Client) *ContractRepository {
...
func (c *ContractRepository) UpsertByAddress(pCtx context.Context, pAddress persist.Address, pUpsert persist.Contract) error {
...
func (c *ContractRepository) BulkUpsert(pCtx context.Context, contracts []persist.Contract) error {
