...
// LoginRepository is a repository for storing login attempts in a MongoDB database
type LoginRepository struct {
	loginsStorage *storage
}

// NonceRepository is a repository for storing authentication nonces in a MongoDB database
type NonceRepository struct {
	mp *storage
}

// NewLoginRepository returns a new instance of a login attempt repository
func NewLoginRepository(mgoClient *mongo.Client) *LoginRepository {
...
func (l *LoginRepository) Create(pCtx context.Context, pLoginAttempt persist.UserLoginAttempt) (persist.DBID, error) {
