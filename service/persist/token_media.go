...
type ErrContractOwnerNotFound struct {
	ContractID DBID
}

func (e ErrContractOwnerNotFound) Error() string {
	return fmt.Sprintf("ContractOwner not found for contractID %s", e.ContractID)
}
