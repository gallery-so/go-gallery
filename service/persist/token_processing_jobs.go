...
type PipelineMetadata struct {
	...
	ExtraSourceContentHeaderValueRetrieval  PipelineStepStatus `json:"extra_source_content_header_value_retrieval,omitempty"`
	ExtraSourceReaderRetrieval              PipelineStepStatus `json:"extra_source_reader_retrieval,omitempty"`
	ExtraSourceOpenseaFallback              PipelineStepStatus `json:"extra_source_opensea_fallback,omitempty"`
	ExtraSourceDetermineMediaTypeWithReader PipelineStepStatus `json:"extra_source_determine_media_type_with_reader,omitempty"`
	ExtraSourceAnimationGzip                PipelineStepStatus `json:"extra_source_animation_gzip,omitempty"`
	ExtraSourceSVGRasterize                 PipelineStepStatus `json:"extra_source_svg_rasterize,omitempty"`
	ExtraSourceStoreGCP                     PipelineStepStatus `json:"extra_source_store_gcp,omitempty"`
	ExtraSourceThumbnailGCP                 PipelineStepStatus `json:"extra_source_thumbnail_gcp,omitempty"`
	ExtraSourceLiveRenderGCP                PipelineStepStatus `json:"extra_source_live_render_gcp,omitempty"`
