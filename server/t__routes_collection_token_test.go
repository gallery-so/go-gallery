...
func seedTokens(assert *assert.Assertions) []persist.DBID {
	nfts := []persist.TokenGallery{
		{CollectorsNote: "asd", OwnerAddress: tc.user1.address, TokenID: persist.TokenID(util.RandHexString(10)), ContractAddress: persist.EthereumAddress(util.RandEthAddress())},
		{CollectorsNote: "bbb", OwnerAddress: tc.user1.address, TokenID: persist.TokenID(util.RandHexString(10)), ContractAddress: persist.EthereumAddress(util.RandEthAddress())},
		{CollectorsNote: "wowowowow", OwnerAddress: tc.user1.address, TokenID: persist.TokenID(util.RandHexString(10)), ContractAddress: persist.EthereumAddress(util.RandEthAddress())},
	}
