...
func arbitrumProvidersConfig(arbitrumProvider2 *arbitrumProvider, openseaProvider *opensea.Provider) arbitrumProviderList {
	serverArbitrumProviderList := arbitrumRequirements(arbitrumProvider2, arbitrumProvider2, arbitrumProvider2, arbitrumProvider2, openseaProvider)
	return serverArbitrumProviderList
}
...
func arbitrumRequirements(
	...
	return arbitrumProviderList{tof, toc, tiof, tmf, opensea2}
}
