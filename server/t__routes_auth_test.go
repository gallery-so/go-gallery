...
func TestUserLogin_Success(t *testing.T) {
	...
	resp := loginRequest(assert, "0x7d3b810c5ae6efa6e5457f5ed85fe048f623b0f1127a7825f119a86714b72fec444d3fa301c05887ba1b94b77e5d68c8567171404cff43b7790e8f4d928b752a1b", nonce.Address)
	assertValidResponse(assert, resp)
...
func TestUserLogin_WrongAddr_Failure(t *testing.T) {
	...
	resp := loginRequest(assert, "0x7d3b810c5ae6efa6e5457f5ed85fe048f623b0f1127a7825f119a86714b72fec444d3fa301c05887ba1b94b77e5d68c8567171404cff43b7790e8f4d928b752a1b", "0xcb1b78568d0Ef81585f074b0Dfd6B743959070D9")
	assertErrorResponse(assert, resp)
}
...
func TestUserLogin_NoNonce_Failure(t *testing.T) {
	...
	resp := loginRequest(assert, "0x7d3b810c5ae6efa6e5457f5ed85fe048f623b0f1127a7825f119a86714b72fec444d3fa301c05887ba1b94b77e5d68c8567171404cff43b7790e8f4d928b752a1b", "0x9a3f9764B21adAF3C6fDf6f947e6D3340a3F8AC5")
	assertErrorResponse(assert, resp)
}
...
func loginRequest(assert *assert.Assertions, sig string, address persist.Address) *http.Response {
	body := map[string]interface{}{"address": address, "signature": sig}
	asJSON, err := json.Marshal(body)
	assert.Nil(err)
	req, err := http.NewRequest("POST",
